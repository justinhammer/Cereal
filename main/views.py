...
def update_view(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            cereal_object.protein = form.cleaned_data['protein']
            cereal_object.fat = form.cleaned_data['fat']
            cereal_object.sodium = form.cleaned_data['sodium']
            cereal_object.fiber = form.cleaned_data['fiber']
            cereal_object.carbs = form.cleaned_data['carbs']
            cereal_object.sugars = form.cleaned_data['sugars']
